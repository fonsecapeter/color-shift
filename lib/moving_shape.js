...
MovingShape.prototype.bounceOther = function (other) {
  ...
  if (Util.dotProduct(velocityDiff, dispDiff) < 0) {
    ...
    this.reflectiveForce[0] *= (newVelocity[0] / this.velocity[0]) * 0.95;
    this.reflectiveForce[1] *= (newVelocity[1] / this.velocity[1]) * 0.95;
    other.reflectiveForce[0] *= (newOtherVelocity[0] / other.velocity[0]) * 0.95;
    other.reflectiveForce[1] *= (newOtherVelocity[1] / other.velocity[1]) * 0.95;
