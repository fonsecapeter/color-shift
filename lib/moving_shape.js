...
MovingShape.prototype.bounceOther = function (other) {
  ...
  if (Util.dotProduct(velocityDiff, dispDiff) < 0) {
    ...
    this.reflectiveForce[0] *= (newVelocity[0]) * 0.95;
    this.reflectiveForce[1] *= (newVelocity[1]) * 0.95;
    other.reflectiveForce[0] *= (newOtherVelocity[0]) * 0.95;
    other.reflectiveForce[1] *= (newOtherVelocity[1]) * 0.95;
  }
};
